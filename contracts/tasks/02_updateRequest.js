...
const functionsConsumerABI = require("./abis/functionsConsumer.json");
...
task("update-function-api-attributes", "Update post request API for function consumer")
    ...
    .setAction(async (taskArgs, hre) => {
        ...
        const source = fs
            .readFileSync(path.resolve(__dirname, "./sources/promtToAttributes.js"))
            .toString();
...
task("update-function-api-images", "Update post request API for function consumer")
    .addParam("consumeraddress", "address of GenrateImagesFunctionConsumer.sol")
    .addParam("subscriptionid", "chainlink subscription ID")
    .setAction(async (taskArgs, hre) => {
        const { consumeraddress, subscriptionid } = taskArgs
        ...
        const source = fs
            .readFileSync(path.resolve(__dirname, "./sources/promtToImages.js"))
            .toString();
